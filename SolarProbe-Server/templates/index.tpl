...
<TR>
  <TD ALIGN=RIGHT><FONT FACE="Arial, Helvetica" SIZE="-2" COLOR="silver"><B><A HREF="http://xymon.sourceforge.net/" style="text-decoration: none">SolarProbe {{{VERSION}}}</A></B></FONT></TD>
</TR>
</TABLE>
